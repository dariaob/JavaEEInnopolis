...
COMMENT ON COLUMN doctor_schedule_slots.doctor_schedule_id IS 'Ссылка на расписание врача';
...
CREATE TABLE IF NOT EXISTS appointments (
                                            ...
                                            FOREIGN KEY (slot_id) REFERENCES doctor_schedule_slots ON DELETE RESTRICT ON UPDATE CASCADE,
                                            FOREIGN KEY (office_id) REFERENCES offices(id) ON DELETE RESTRICT ON UPDATE CASCADE
);
